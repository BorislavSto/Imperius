...
namespace Combat
{
    ...
    public class AttackHandler : MonoBehaviour
    {
        ...
        [Header("Melee Exclusive config")] [ShowIf(EConditionOperator.Or, "IsMelee", "IsAllTypes")] [SerializeField]
        private Collider damageArea;

        [ShowIf(EConditionOperator.Or, "IsMelee", "IsAllTypes")] [SerializeField]
        private DamageRelay dmgRelay;

        public Collider DamageArea => damageArea;
        public DamageRelay DmgRelay => dmgRelay;

        [Header("Ranged Exclusive config")] [ShowIf(EConditionOperator.Or, "IsRanged", "IsAllTypes")] [SerializeField]
